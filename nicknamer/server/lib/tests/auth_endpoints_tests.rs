...
async fn can_login_with_valid_credentials() {
    ...
    let snapshot_data = HttpResponseSnapshot::new(body_text, status, &headers, "login_with_valid_credentials");
...
async fn can_reject_invalid_credentials() {
    ...
    let snapshot_data = HttpResponseSnapshot::new(body_text, status, &headers, "reject_invalid_credentials");
...
async fn can_handle_template_error_with_internal_server_error() {
    ...
    let snapshot_data = HttpResponseSnapshot::new(body_text, status, &headers, "handle_template_error");
...
async fn can_display_login_page() {
    ...
    let snapshot_data = HttpResponseSnapshot::new(body_text, status, &headers, "display_login_page");
