...
7. Structured output from the real logging listener contains required names, levels, and correlation fields, and excludes sentinel secrets carried by representative raw input errors.
