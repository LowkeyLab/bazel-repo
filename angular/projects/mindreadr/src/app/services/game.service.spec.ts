...
describe('GameService', () => {
  ...
  it('getGamesByStatus should fetch /games?status=IN_PROGRESS', (done) => {
    const mockGames: GameDto[] = [
      { id: 'IP1', state: 'IN_PROGRESS', playerLimit: 2, turnLimit: 10, players: [], rounds: [] },
      { id: 'IP2', state: 'IN_PROGRESS', playerLimit: 2, turnLimit: 10, players: [], rounds: [] },
      { id: 'IP3', state: 'IN_PROGRESS', playerLimit: 2, turnLimit: 10, players: [], rounds: [] },
    ];
  ...
  it('getGamesByStatus should fetch /games?status=COMPLETED', (done) => {
    const mockGames: GameDto[] = [
      { id: 'C1', state: 'COMPLETED', playerLimit: 2, turnLimit: 10, players: [], rounds: [] },
    ];
