...
class GamesHttpTest {
  ...
  @Test
  fun `post games creates game`() = testApplication {
  ...
  @Test
  fun `get games id returns game`() = testApplication {
  ...
  @Test
  fun `get games id not found`() = testApplication {
    val service = GameService(TestPlayerFactory(), InMemoryGameRepository())
    application {
      configureSerialization()
      configureGames(service)
  ...
  @Test
  fun `get games status waiting`() = testApplication {
    val repo = InMemoryGameRepository()
    val service = GameService(TestPlayerFactory(), repo)
    application {
      configureSerialization()
  ...
  @Test
  fun `get games status in progress`() = testApplication {
    val repo = InMemoryGameRepository()
    val service = GameService(TestPlayerFactory(), repo)
    application {
      configureSerialization()
  ...
  @Test
  fun `get games status completed`() = testApplication {
    val repo = InMemoryGameRepository()
    val service = GameService(TestPlayerFactory(), repo)
    application {
      configureSerialization()
  ...
  @Test
  fun `get games invalid status`() = testApplication {
    val service = GameService(TestPlayerFactory(), InMemoryGameRepository())
    application {
      configureSerialization()
      configureGames(service)
  ...
  @Test
  fun `get games without status message`() = testApplication {
    val service = GameService(TestPlayerFactory(), InMemoryGameRepository())
    application {
      configureSerialization()
      configureGames(service)
  ...
  @Test
  fun `get games summary counts`() = testApplication {
    val repo = InMemoryGameRepository()
  ...
  @Test
  fun `get games case insensitive status`() = testApplication {
    val repo = InMemoryGameRepository()
    val service = GameService(TestPlayerFactory(), repo)
    application {
      configureSerialization()
