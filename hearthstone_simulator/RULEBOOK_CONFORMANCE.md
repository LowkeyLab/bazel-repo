...
| Guarded deferred steps and checkpoint restoration                   | Engine policy       | `SubjectGuard`, schema 9           | skip/round-trip/fork/reference tests  | Implemented foundation; schemas 7/8 rejected       |
...
Weapons, Hero cards, locations, and Hero Powers remain Milestone 8 work. Checkpoint schema 9 is
the only accepted action-contract checkpoint schema; older schema versions, including 7 and 8,
are rejected.
