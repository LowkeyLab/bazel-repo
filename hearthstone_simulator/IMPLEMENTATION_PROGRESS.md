...
- Verification: 2026-09-14 formatting, 9 core and 258 simulator tests, and the full repository build pass. Lint reports no filtered findings; unrelated website ESLint formatter errors for missing `chalk` limit that check.
...
- [x] **7 — General mechanics**
  ...
  - [x] Temporary stat, keyword, and ordered cost enchantments with end-of-turn and end-of-turn-series expiration.
...
- [ ] **8 — Player-action sequences**
  ...
  - [x] Explicit action contracts: four targeting requirements, read-only declaration validation, normalized minion placement, captured declared targets, and rejected nonempty choices.
  - [x] Canonical enumeration of supported actions: deterministic card/target/position/attack order, explicit minion insertion positions, and no enumeration mutation.
  ...
  - [ ] Weapon, Hero card, and location action sequences; combat redirection; full phase guards; and keyword-specific targeting or combat legality.
...
| 2026-08-30 | `aspect lint`                                                                  | Passed all repository linters                                                     |
| 2026-08-30 | `aspect build //...`                                                           | Passed full repository build                                                      |
| 2026-09-04 | `bazel run //:gazelle`                                                         | Passed; no BUILD metadata changes                                                 |
| 2026-09-04 | `aspect format --scope=all`                                                    | Passed; no formatter changes                                                      |
| 2026-09-04 | `aspect test //hearthstone_simulator/...`                                      | Passed 4 core and 147 simulator tests                                             |
...
| 2026-09-12 | `aspect format --scope=all`                                                    | Passed; reformatted `RULEBOOK_CONFORMANCE.md`                                     |
| 2026-09-12 | `aspect test //hearthstone_simulator/...`                                      | Passed 2/2 tests (cached)                                                         |
| 2026-09-12 | `aspect lint`                                                                  | Passed 343 targets; 7 linters, no findings                                        |
| 2026-09-12 | `aspect build //...`                                                           | Passed all 351 repository targets                                                 |
| 2026-09-14 | `aspect test //hearthstone_simulator/...`                                      | Passed 9 core and 258 simulator tests, including 12 Hero Power regressions        |
| 2026-09-14 | `bazel run //:gazelle`                                                         | Passed after each source-edit batch                                               |
| 2026-09-14 | `aspect format --scope=all`                                                    | Passed repository formatting                                                      |
| 2026-09-14 | `aspect build //...`                                                           | Passed all 351 repository targets                                                 |
| 2026-09-14 | `aspect lint`                                                                  | No filtered findings; unrelated website ESLint formatter reported missing `chalk` |

## Known gaps

Milestone 8 remains partial. Its current foundation covers minion/spell declarations and synthetic Hero Power activation,
basic audience/kind targeting filters, canonical action enumeration, and narrow zone-continuity
guards. It does not claim complete rulebook targeting or combat legality, keyword restrictions,
...
verification. Checkpoints use schema 10 and reject older schemas, including schemas 7, 8, and 9.
