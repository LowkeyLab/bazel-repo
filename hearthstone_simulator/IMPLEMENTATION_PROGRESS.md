...
- Verification: 2026-09-12 formatting, all Hearthstone targets, repository lint, and the full repository build pass
...
- [ ] **8 — Player-action sequences**
  ...
  - [ ] Weapon, Hero card, location, and Hero Power action sequences; combat redirection; full phase guards; and keyword-specific targeting or combat legality.
...
Milestone 8 remains partial. Its current foundation covers only minion and spell declarations,
...
combat redirection, full phase guards, or action sequences for Weapons, Hero cards, locations, or
Hero Powers. Checkpoints use schema 9 and reject older schemas, including schemas 7 and 8.
